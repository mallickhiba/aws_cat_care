...
class EditCatDetailScreen extends StatefulWidget {
  ...
  @override
  State<EditCatDetailScreen> createState() => EditCCatDetailScreenState();
}

class EditCCatDetailScreenState extends State<EditCatDetailScreen> {
                      ...
                      MaterialPageRoute(
                        builder: (context) => BlocProvider(
                          create: (context) => GetIncidentsForCatBloc(
                            ...
                            ..add(GetIncidentsForCat(catId: editableCat.catId)),
