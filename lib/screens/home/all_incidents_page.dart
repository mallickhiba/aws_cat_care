    ...
    return BlocListener<CreateIncidentBloc, CreateIncidentState>(
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            Expanded(
              child: BlocBuilder<GetAllIncidentsBloc, GetAllIncidentsState>(
                builder: (context, state) {
                  if (state is GetAllIncidentsSuccess) {
                  ...
                  } else if (state is GetAllIncidentsLoading) {
